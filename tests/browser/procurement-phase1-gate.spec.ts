...
async function auth(page:Page){await page.addInitScript(()=>{localStorage.setItem('scm-demo-token','phase1');localStorage.setItem('scm-demo-user',JSON.stringify({id:'procurement-manager',name:'采购经理',role:'采购经理'}))})}
