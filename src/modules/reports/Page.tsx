...
type SourceKind = "Demo" | "Sample" | "API" | "API fallback" | "Module";
  ...
  const reports = useMemo<ReportEntry[]>(() => [
    {
      ...
      module: "销售",
      description: "月度销售额、订单量与毛利率标准样例报表。",
      source: "salesData · demo-data.ts",
      sourceKind: "Demo",
    ...
    },
    {
      ...
      source: "topProducts · demo-data.ts",
      sourceKind: "Demo",
      updated: "Demo sample · 2026",
    ...
    },
    {
      ...
      source: "PORTAL_SUPPLIERS · API fallback sample",
      sourceKind: "API fallback",
      updated: "API fallback sample",
    ...
    },
    {
      ...
      source: "purchaseOrders · demo-data.ts",
      sourceKind: "Demo",
      updated: "Demo sample · 2026",
    ...
    },
    {
      ...
      source: "receivingDocs · demo-data.ts",
      sourceKind: "Demo",
      updated: "Demo sample · 2026",
    ...
    },
    {
      ...
      source: "COUNT_PLANS · demo-data.ts",
      sourceKind: "Demo",
      updated: "Demo sample · 2026",
    ...
    },
    {
      ...
      source: "inventoryItems · computed sample",
      sourceKind: "Sample",
      updated: "Computed standard sample",
    ...
    },
    {
      ...
      module: "预测/MRP",
      description: "原始销售预测样例趋势、实际值、预测值和上下界。",
      source: "forecastData · demo-data.ts",
      sourceKind: "Demo",
      updated: "Demo sample · 2026",
    ...
    },
    {
      ...
      module: "预测/MRP",
      description: "后端 MRP 计划例外、期间、数量、金额和建议动作。",
