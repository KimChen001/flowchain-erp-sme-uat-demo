...
const PAGE_LABELS: Record<string, string> = {
  ...
  procurement: "采购管理", finance: "财务协同", "master-data": "基础资料", srm: "供应商管理", reports: "报表与分析", imports: "数据接入与质量", "exception-cases": "异常处理工单", "collaboration-drafts": "协同通知草稿", "review-actions": "行动草稿与人工复核", "audit-history": "业务审计与历史", settings: "系统设置",
};
...
export default function FlowChainApp() {
  ...
  const contentMaxWidthClass = activeModule === "srm"
    ? "max-w-[1440px]"
    : ["overview", "reports", "imports", "review-actions", "collaboration-drafts", "audit-history", "settings"].includes(activeModule)
      ? "max-w-[1360px]"
      : "max-w-[1320px]";
