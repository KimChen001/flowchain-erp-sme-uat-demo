...
export const appRouteRegistry: AppRouteDefinition[] = [
  ...
  page({ id: "procurement:workbench", path: "/app/procurement/workbench", moduleId: "procurement", moduleLabel: "采购管理", label: "采购工作台", description: "查看采购执行概况。", parentId: "procurement", pageType: "analysis", viewId: "orders", order: 30.1 }),
  ...
  page({ id: "procurement:invoices", path: "/app/procurement/invoices", moduleId: "procurement", moduleLabel: "采购管理", label: "供应商发票", description: "查看供应商发票及匹配状态。", parentId: "procurement", pageType: "list", panelId: "finance", viewId: "invoices", order: 35 }),
