...
export function buildPurchaseRequestDraftPreview(input = {}, options = {}) {
  ...
  const draftPayload = cleanObject({
    ...
    buyer: text(payloadInput.buyer),
    unitPrice: toNumberOrNull(payloadInput.unitPrice),
    amount: toNumberOrNull(payloadInput.amount),
    ...
    forecastBasis: payloadInput.forecastBasis,
    mrpEvidence: payloadInput.mrpEvidence,
