...
test('repository registry defaults to JSON without DATABASE_URL', () => {
  ...
  assert.deepEqual(Object.keys(registry), ['mode', 'masterData', 'inventoryRead', 'inventoryRuntime', 'salesOrders', 'procurementRead', 'actionDrafts', 'exceptionCases', 'auditLog', 'aiConversation', 'userDataRuntime', 'userConfirmedActions', 'procurementTransactions'])
