...
export const capabilityRegistry = [
  ...
  capability('return-request', 'beta', false, false, 'Database-only governed return request foundation', { databaseOnly: true, requiresExplicitEnable: true, environmentFlag: 'FLOWCHAIN_ENABLE_DB_RETURNS_QUARANTINE' }),
  capability('return-authorization', 'beta', false, false, 'Database-only return authorization foundation', { databaseOnly: true, requiresExplicitEnable: true, environmentFlag: 'FLOWCHAIN_ENABLE_DB_RETURNS_QUARANTINE' }),
