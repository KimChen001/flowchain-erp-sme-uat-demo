...
function plainBalance(balance) {
  return {
    ...
    onHandQuantity: text(balance.onHandQuantity),
    availableQuantity: text(balance.availableQuantity),
    reservedQuantity: text(balance.reservedQuantity),
...
function plainMovement(movement) {
  return {
    ...
    quantityIn: text(movement.quantityIn),
    quantityOut: text(movement.quantityOut),
    adjustmentQty: text(movement.adjustmentQty),
