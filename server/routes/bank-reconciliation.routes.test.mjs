...
test("bank reconciliation API routes cover candidates, groups, confirmation, reversal and exceptions", async () => {
  ...
  const cases = [
    ...
    ["GET", "/api/finance/bank-reconciliation/exceptions", "listExceptions"], ["POST", "/api/finance/bank-reconciliation/exceptions/E-1/resolve", "resolveException"], ["GET", "/api/finance/bank-reconciliation/cashbook-entries/CB-1/summary", "cashbookSummary"],
  ];
