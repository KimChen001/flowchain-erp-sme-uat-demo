...
export function createJsonMasterDataRepository(db = {}, options = {}) {
  ...
  return {
    ...
    applyItemImportBatch: (rows, actor, metadata) => items.applyImportBatch(rows, actor, metadata),
    ...
    applyCustomerImportBatch: (rows, actor, metadata) => customers.applyImportBatch(rows, actor, metadata),
    ...
    applySupplierImportBatch: (rows, actor, metadata) => suppliers.applyImportBatch(rows, actor, metadata),
